function validate()
{
   if( document.savehs.ho.value == "" )
   {
     alert( "Nhập Họ và tên lót" );
     document.savehs.ten.focus() ;
     return false;
   }
   if( document.savehs.ten.value == "" )
   {
     alert( "Nhập tên" );
     document.savehs.ten.focus() ;
     return false;
   ...
   if( document.savehs.diachi.value == "" )
   {
     alert( "Nhập địa chỉ" );
     document.savehs.ten.focus() ;
     return false;
   }
   if( document.savehs.sdt.value == "" )
   {
    ...
    //     return false;
    //   }
      if(document.nhapdiem.diem.value.length > 10 )
       {
         alert( "Vui lòng nhập điểm trong khoảng 0-10" );
         document.nhapdiem.diem.focus() ;
         return false;
       }
   return true;
}